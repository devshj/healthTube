      ...
      <td align=center>
          ...
          <table width=810>
            <tr>
              <td>
                <div>
                 <font color="#9400d3" size=4>01</font> <font size=3>서비스 이용약관</font>
                </div>
             </td>
           </tr>
           <tr>
...
제1조(목적)
 이 약관은 HealthTube 회사가 운영하는 HealthTube 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련
 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리ㆍ의무 및 책임사항을 규정함을 목적으로 합니다.

 ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
 ①“몰” 이란 HealthTube 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <tr>
              <td>
                <input type="checkbox" name="req">이용약관에 동의합니다.<br><br><br><br>
              </td>
            </tr>
            <tr>
              <td>
                <div>
                 <font color="#9400d3" size=4>02</font> <font size=3>개인정보 수집 및 이용에 대한 안내</font>
                </div>
             </td>
           </tr>
           <tr>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
            ...
            <tr>
              <td>
                <input type="checkbox" name="req2">개인정보 수집 및 이용에 대한 안내에 동의합니다.
              </td>
            </tr>
          </table>
...
<br><br>
  <button type = "button" onclick="chk()"  style="margin:10px;">동 의 하 기</button></a>
  <a href="index.php"> <button type = "button"   style="margin:10px;">취 소 하 기</button></a>
    </center>
  </form>
  </body>
